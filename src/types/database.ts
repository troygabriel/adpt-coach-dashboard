// Generated by `supabase gen types typescript --linked` against the shared
// ADPT Supabase project. Source of truth lives at
// ~/troyg/Projects/ADPT/types/database.ts — this file is a copy so the
// dashboard can typecheck without a cross-repo path. Re-copy after every
// schema migration.
